...
namespace Offsets {
    ...
    namespace VisualEngine {
        inline constexpr uintptr_t VisualEnginePointer = 0x78B9AC8; // (uintptr_t) (Roblox::VisualEnginePointer)
        inline constexpr uintptr_t FakeDataModelPointer = 0x808; // (uintptr_t) (VisualEnginePointer::FakeDataModelPointer)
        inline constexpr uintptr_t FakeDataModelToDataModel = 0x1C0; // (uintptr_t) (FakeDataModelPointer::FakeDataModelToDataModel)
    }

    namespace Workspace {
        inline constexpr uintptr_t Terrain = 0x498; // (uintptr_t) (Workspace::Terrain)
        inline constexpr uintptr_t Camera = 0x488; // (uintptr_t) (Workspace::Camera)
        inline constexpr uintptr_t WorkspaceToWorld = 0x400; // (uintptr_t) (Workspace::World)
    }

    namespace World {
        inline constexpr uintptr_t WorldStepsPerSecond = 0x668; // (float) (World::WorldStepsPerSecond) | Default value is 240
        inline constexpr uintptr_t Gravity = 0x1D8; // (float) (World::Gravity)
    }

    namespace Instance {
        inline constexpr uintptr_t Name = 0xB0; // (string) (Instance::Name)
        inline constexpr uintptr_t Children = 0x78; // (uintptr_t) (Instance::Children)
        inline constexpr uintptr_t ChildrenEnd = 0x8; // (uintptr_t) (Instance::ChildrenEnd)
        inline constexpr uintptr_t Parent = 0x70; // (uintptr_t) (Instance::Parent)
    ...
    namespace Player {
        inline constexpr uintptr_t UserId = 0x2C8; // (uintptr_t) (LocalPlayer::UserId)
        inline constexpr uintptr_t ModelInstance = 0x398; // (uintptr_t) (LocalPlayer::ModelInstance)
        inline constexpr uintptr_t CameraMinZoomDistance = 0x324; // (float) (LocalPlayer::CameraMinZoomDistance)
        inline constexpr uintptr_t CameraMaxZoomDistance = 0x320; // (float) (LocalPlayer::CameraMaxZoomDistance)
    ...
    namespace BasePart {
        ...
        inline constexpr uintptr_t AudioCanCollide = 0x2C5; // (bool) (BasePart::AudioCanCollide)
